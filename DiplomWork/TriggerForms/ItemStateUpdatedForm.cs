...
{
    public partial class ItemStateUpdatedForm : System.Windows.Forms.Form
    {

        protected List<string> _itemList;
        protected List<string> _stateList = new List<string> { "CLOSED", "OPEN", "DOWN", "UP", "OFF", "ON" };
        public ItemStateUpdatedForm(List<string> itemList)
        {
            _itemList = itemList;
            InitializeComponent();
        ...
        public ItemStateUpdatedForm(List<string> itemList, string item, string state)
        {
            _itemList = itemList;
            InitializeComponent();
            for (int i = 0; i < _itemList.Count; i++)

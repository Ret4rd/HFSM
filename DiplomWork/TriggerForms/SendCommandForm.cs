...
namespace DiplomWork.TriggerForms
{
    public partial class SendCommandForm : System.Windows.Forms.Form
    {
        ...
        public SendCommandForm(List<string> itemList, string item, string state)
        {
            _itemList = itemList;
            InitializeComponent();
            for (int i = 0; i < _itemList.Count; i++)
